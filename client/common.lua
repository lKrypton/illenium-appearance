-- Shared across all client files (same Lua state in FiveM)
-- Set when player enters a clothing zone, read as fallback in openClothingShopMenu
_currentClothingShopType = "binco"
