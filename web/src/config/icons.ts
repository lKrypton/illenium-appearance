...
export const icons = {
  ...
  // ── Appearance Section (Head Overlays) ──
  appearance: {
    blemishes: 'droplet',
    beard: 'scissors',
    eyebrows: 'glasses',
    ...
    makeUp: 'paintbrush',
    blush: 'heart',
    complexion: 'fingerprint',
    sunDamage: 'sun',
    lipstick: 'star',
    moleAndFreckles: 'star',
    chestHair: 'fire',
    bodyBlemishes: 'kit-medical',
  },
