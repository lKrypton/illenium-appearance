...
-- ════════════════════════════════════════════════════════════════════
-- Theme colors  → shared/theme.lua
-- Tab / section visibility → below
-- ════════════════════════════════════════════════════════════════════

Config.UI = {}

-- Which tabs are visible per shopType.
-- Available IDs: model, heritage, face, appearance, hair, clothing, accessories, tattoos
...
-- Add/remove keys to control what shows up. Order in this list = display order.
Config.UI.Sections = {
    clothing = {
        "jackets", "shirts", "upperBody", "lowerBody",
        "shoes", "decals", "masks", "bodyArmor", "bags", "scarfAndChains",
    },
    accessories = {
        "hats", "glasses", "ear", "watches", "bracelets",
    },
    appearance = {
        "blemishes", "ageing", "complexion", "sunDamage", "moleAndFreckles",
        "eyebrows", "beard", "chestHair", "bodyBlemishes",
        "makeUp", "blush", "lipstick", "eyeColor",
    },
    hair = {
        "style", "color", "highlight", "texture", "fade",
    },
    face = {
        "nose", "eyebrows", "cheeks", "eyesAndMouth", "jaw", "chin", "neck",
    },
}
...
Config.Stores = {
    -- shopType controls the UI theme for clothing stores.
    -- Options: "binco" (default), "ponsonbys" (luxury), "suburban" (sport/skate)
    -- Barber, tattoo, surgeon shops set their own theme automatically.
    {
        type = "clothing",
        shopType = "binco", -- Paleto Bay
    ...
    {
        type = "clothing",
        shopType = "ponsonbys", -- Ponsonbys – Portola Drive
    ...
    {
        type = "clothing",
        shopType = "suburban", -- Del Perro / Vespucci
    ...
    {
        type = "clothing",
        shopType = "binco", -- Adam's Apple Blvd / Strawberry
    ...
    {
        type = "clothing",
        shopType = "ponsonbys", -- Rockford Hills
    ...
    {
        type = "clothing",
        shopType = "binco", -- Davis / Chamberlain Hills
    ...
    {
        type = "clothing",
        shopType = "binco", -- Paleto Bay (north)
    ...
    {
        type = "clothing",
        shopType = "binco", -- Grand Senora Desert
    ...
    {
        type = "clothing",
        shopType = "binco", -- Zancudo / Chumash
